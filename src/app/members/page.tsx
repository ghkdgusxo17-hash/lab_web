...
import { Mail, GraduationCap, Edit, User, ArrowRight } from 'lucide-react'
...
function MemberCard({ member, isAdmin }: MemberCardProps) {
    return (
        <div className="group relative bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-lg shadow-slate-200/50 dark:shadow-none hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            {isAdmin && (
                <Link
