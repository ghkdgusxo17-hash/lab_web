...
import { LabNoteSettingsCard } from './LabNoteSettingsCard'
import { MedalBadge } from '@/components/ui/MedalBadge'
import { User } from 'lucide-react'
import { getGoogleCalendarStatus } from '@/actions/google-calendar'
import { getMyLabNoteSettings } from '@/actions/lab-note'
...
export default async function SettingsPage() {
    ...
    const [calendarStatus, labNoteSettings] = await Promise.all([
        getGoogleCalendarStatus(),
        getMyLabNoteSettings(),
    ])
            ...
            <main className="min-h-screen pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <GoogleCalendarSettings
                        ...
                        syncConfigs={calendarStatus.syncConfigs || []}
                    />
                    ...
                    <LabNoteSettingsCard {...labNoteSettings} />
                </div>
            </main>
        </>
    )
